...
class Block {
    readonly _startTime: ScheduleTime;
    readonly _endTime: ScheduleTime;
    readonly _title: string;
    readonly _location: string;
    readonly _label: string;

    constructor(startTime: ScheduleTime, endTime: ScheduleTime, title: string, location: string, label: string) {
...
class RawBlock extends Block {
    readonly _dayMeta: ScheduleDayMeta;

    constructor(dayMeta: ScheduleDayMeta, startTime: ScheduleTime, endTime: ScheduleTime, title: string, location: string, label: string) {
        super(startTime, endTime, title, location, label);
        this._dayMeta = dayMeta;
    }

    get block() {
        return new Block(this._startTime, this._endTime, this._title, this._location, this._label);
    }
}

class ScheduleDayMeta {
    readonly _date: ScheduleDate;
    readonly _letter: string;

    constructor(date: ScheduleDate, letter: string) {
        this._date = date;
        this._letter = letter;
    }
}
...
class ScheduleBuilder {
    ...
    static generateScheduleFromBlockSources(id: string, sources: RawBlockSources[])
